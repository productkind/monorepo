...
- **Saveable, reference-later content wins the metric that matters** (saves).
  Four of the five posts are checklists, recipes, or decision guides the
  audience can save and reuse; they mirror toolkit items the course already
  ships, so this is reuse, not new material.
- **Credits are the No. 1 blocker** ("credits credits credits"). Every post
  leads with the credit-saving payoff, priced against tool spend, never with
  fear or urgency.
- **The comic post reuses made assets** (the Dalmie panels), per the
  reuse-first Instagram rule, and frames the learner's pain, never the tool.
- **Concrete outcomes beat encouragement** for this audience, so each post
  promises something specific ("three commands", "for free", "one credit").
...
- The first challenge of the course is free; the CTAs say so, since free-course
  links are our lead magnet.
- Carousel slides: 1080 x 1350 (4:5 portrait), Little Parrot brand colours,
  large type, one idea per slide. The comic post stays square (1080 x 1080)
  to match the panel art.
