...
| --- | --- | --- | --- |
| 1 (cover) | Big type; a prompt window peeks in from the bottom edge, markdown faintly visible | "Your first Lovable prompt: the structure that gets you close on the first try." | Faint ghost text: `## Product overview` `## User flow` `## Design system` |
| 2 | Two prompt windows: a small grey one, a taller structured one with section headings visible | "'Make me an app for my book club' gets you something generic. Vague prompts get vague results. A structured prompt gets you much closer. 👉🏼" | Grey window: `Make me an app for my book club` · Structured window: `## Product overview` `## User flow` `## Design system` `## Target user` |
