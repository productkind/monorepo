...
> Researched 2026-07-05, decisions confirmed by Kinga 2026-07-06. Reference
> this when designing or reviewing carousel campaigns. Refresh the findings
> roughly every 6 months or when Instagram announces ranking changes.

## What the 2026 evidence says

### Reach and engagement mechanics

- **Carousels out-reach single images** (roughly 1.7x to 3x depending on the
  study) and earn about **2x the saves of Reels**. Engagement rate ~0.55%,
  ahead of Reels, steady since 2023.
- **The re-serve mechanic:** Instagram re-serves carousels with high
  swipe-through 24-48 hours after posting, showing unseen slides to people
  who scrolled past. One carousel earns impressions over days. Swipe-through
  and completion are the signals to design for.
...
- **Reels still reach more strangers:** ~2.35x the reach of static posts and
  far more non-followers. Carousels convert and nurture; Reels discover.
  (The Reels/TikTok experiment in `idea-backlog.md` is the discovery layer;
  carousels are the value layer.)
...
- **8-12 slides** is the sweet spot for educational carousels (more swipes,
  more completion signal, more re-serve surface). Longer (12-20) only for
  deep guides.
...
4. **Shorten slides by splitting, never by stripping.** To hit flashcard
   density and the 8-12 slide sweet spot, split a dense slide into two;
   don't compress away the explanation or example that makes it valuable.
   (Same principle as course steps: shorten by splitting.)
...
- [Second Brain: carousel vs Reels for followers, 2026](https://www.thesecondbrain.io/blog/carousel-vs-reels-2026-which-gets-you-followers)
