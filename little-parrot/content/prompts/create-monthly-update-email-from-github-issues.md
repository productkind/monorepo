# Create Monthly Update Email From Github Issues

## About
- Tool: Claude Code
- Skills used: /productkind-tone (plus productkind/little-parrot-context.md for company context)
- Needed to authenticate into Github via the terminal beforehand
...
## Follow up prompt
Create a html file for the email that I can diretly drop into Mailtrap. Use the visual identity of Little Parrot. You can find our design system in the ../little-parrot-awakens repo.     