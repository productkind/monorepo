...
- **Recommendation:** brain dump → *On Tap* (fallback *After Pause*); baby log one-liner → *After Pause* (device-confirmed by Kinga 2026-08-10; the course uses After Pause for the Baby Log, not After Short Pause).
