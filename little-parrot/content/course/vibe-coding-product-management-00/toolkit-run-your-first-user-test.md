...
> "Imagine you run a book club and you want to suggest a book for next month. Try to add a book suggestion."
...
- "Would you use this instead of [their current approach]? Why or why not?"
- "Is this solving the right problem for you?"
...
- "Is there anything here you'd never use?"
