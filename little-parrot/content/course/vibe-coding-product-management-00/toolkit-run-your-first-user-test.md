...
**1. "What were you trying to do, and how did it go?"** This reveals whether the app's purpose is clear and whether they could complete the task. If they describe something different from what you intended, your app may not be communicating its purpose well.

**2. "What frustrated you or confused you?"** This surfaces usability problems and bugs. Don't defend your choices. Write down what they say, word for word where you can. If they say "nothing", ask: "Was there any moment where you paused or weren't sure what to do next?"

**3. "What would make this more useful for you?"** This tells you what to build next. Listen for things that align with activities already on your story map. If they suggest something you hadn't thought of, that's even more valuable.
