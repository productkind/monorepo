# Course Outline: Build Your First App with Lovable

**Full title:** Build Your First App with Lovable
...
- Handling security warnings: what they mean and how to respond
- Exercise: Enable planning mode and ask Lovable to add a feature
...
Learners can follow along with this example or apply each concept to their own idea.
...
- Prompt writing (structured formula, iteration)
- Lovable interface (preview, code view, visual edits, assets, themes)
- Version control (bookmarking, reverting)
- Backend basics (planning mode, knowledge files, API keys, Lovable Cloud)
- Publishing (favicon, meta tags, deployment)

---

## Timing

Total estimated time: ~45 minutes (designed so learners have a published app by the end)
