...
| **LLM (Large Language Model)** | An AI model specialised in human language, trained on enormous amounts of text. The thing you're talking to when you use a chat assistant like ChatGPT or Claude.ai, where you type a message and copy the answer out. | It's a language specialist. It's excellent at shaping and rewording what you give it, and unreliable about facts you didn't give it. |
