...
The template below is a bit more detailed as in the course we want to encourage you to include as much information as possible. You can remove any sections that don't apply to your bug, but try to be as thorough as you can in the ones you do fill in. The more information you provide, the easier it will be for Lovable to find and fix the bug without needing to ask you follow-up questions.
...
[Describe what was the state of the app before you did anything, e.g., "I was logged in as a regular user and on the book listing page that had 3 books."]
...
I was logged in as a regular user and on the /books page that had 3 books listed, including "Atomic Habits" which had 3 votes.
