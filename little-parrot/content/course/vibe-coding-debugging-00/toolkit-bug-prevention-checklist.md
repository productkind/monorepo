...
Run through this checklist every time you're about to prompt Lovable and again after it finishes. These habits catch most bugs before they become problems.
...
- [ ] **Did you test the new feature?** Click through the feature yourself. Try the happy path (everything works as intended) and at least one unhappy path (what happens when something goes wrong, like submitting an empty form).
