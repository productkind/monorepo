...
- **What pain it removes** (so people feel the relief)
...
Version 3 won because it named a specific pain point the audience instantly recognised.

### How to test it

1. Write three versions using the formula
2. Tell five people **from your target audience** what your product does, using a different version each time
3. Write down their exact reaction
4. The version that made someone ask "How does it work?" or "Can I try it?" is your winner

### Where you'll use it

- Landing page heading and subheading
- Directory submissions (BetaList, Product Hunt)
- Community posts
- Google Business Profile description
- Emails to early users
- Social media bio
- Any conversation about what you're building
