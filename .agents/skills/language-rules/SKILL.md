...
- **Tool terminology.** "AI chat assistant" for ChatGPT and Codex.ai (you copy the answer out). "AI agent" for Codex and Codex (it acts in your files and shows the changes). Write "AI chat assistant" in full, never "chat assistant". Avoid "chat AI" and "agentic".
