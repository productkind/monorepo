...
[image: A card titled "Chick – Junior Product Manager." It lists pros as eager to learn, kind, and empathetic, and cons as inexperienced and anxious. On the bottom right, there's a cartoon chick wearing a green hoodie, partly sitting in a cracked eggshell. The design is bordered in purple with the logo "productkind" at the bottom.]

@by_productkind on Instagram
...
1. Draw what the user struggles with.
2. Visualise what the user can do and how they feel once the struggle is resolved.
3. Sketch all the moments that lead the user from the initial struggling moment to their happy ending. Show how your solution helps them get there.

These are my drawings, please don't laugh… This is what the user's struggling with.
...
[image: Drawing of what the user struggles with]

Once the struggle is resolved:

- Chick knows what to use AI for
...
[image: Drawing of what the user can do and how they feel once the struggle is resolved]
...
[image: Drawing of all the moments that lead the user from the initial struggling moment to their happy ending.]
...
If you've enjoyed this article, subscribe for free to stay in the loop about new things.
