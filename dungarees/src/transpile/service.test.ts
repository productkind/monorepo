...
test('transpile should transpile a directory', async () => {
  ...
  expect(fs.readFileSync('/dist-dir/file1.js', 'utf-8')).toBe(
    "import { assertDefined } from '@dungarees/core/utils.ts';\nexport const fun1 = (input) => {\n    return assertDefined(input + ' from file1');\n};\n",
  )
  expect(fs.readFileSync('/dist-dir/file1.d.ts', 'utf-8')).toBe(
    'export declare const fun1: (input: string) => string;\n',
  )
  expect(fs.readFileSync('/dist-dir/file2.js', 'utf-8')).toBe(
    "import { fun1 } from './file1.js';\nexport const fun2 = (input) => {\n    return fun1(input + ' and file2');\n};\n",
  )
  expect(fs.readFileSync('/dist-dir/file2.d.ts', 'utf-8')).toBe(
    'export declare const fun2: (input: string) => string;\n',
  )
  ...
  expect(files).toEqual([
    ...
    {
      input: '/src-dir/sub-dir/file3.ts',
      output: '/dist-dir/sub-dir/file3.js',
      type: '/dist-dir/sub-dir/file3.d.ts',
    },
  ])
})
