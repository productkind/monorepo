...
| Comment prompt (42-44s) | "Ever been asked to ship a prototype?" | The "when can we launch this?" message again | Have you been asked this? |
...
- **Screen recording needed:** one small prototype built with an AI agent,
  ...
  list of feature requests. Under a minute, sped up.
