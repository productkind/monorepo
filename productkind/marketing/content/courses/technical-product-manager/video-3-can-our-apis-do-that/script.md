...
|---|---|---|---|
| Hook (0-4s) | "A stakeholder asked for something simple. Just sync it with the CRM." | Screen recording: a one-line request in a ticket | **"It's just a small change"** |
| The moment (4-11s) | "You said yes. Two weeks in, engineering tells you the integration doesn't carry that field, and nobody can add it." | The date being agreed, then the reply arriving, then the date slipping | The integration can't carry it |
...
| The setup (22-27s) | "If you want to answer that before you commit, we're building a learning path for it." | Little Parrot mark, then the learning path list appearing | A learning path for answering first |
| What changes (27-37s) | "By the end you'll be able to open the integrations you already pay for, see what data they can carry, and know whether the request is possible before you answer." | The field list, one name highlighted, then a missing one circled | It's there · it isn't · either way you know first |
...
| Comment prompt (43-45s) | "What 'simple' request turned out hardest?" | The original one-line ticket again | What was yours? |
