...
Every part of every app you've ever used has a name, and your AI builder knows them all. The gap is on our side: when we don't know what the pop-up is called, we describe around it, and the AI guesses. 🧩

The carousel covers the six you'll use most: buttons (and their ranks), cards, modals, inputs, dropdowns, and navigation bars, each with a prompt you can copy and adapt. Once the names are yours, design conversations shrink: "add a card with the title in bold and a View button" is one prompt and one result.

A lovely place to browse more of them is component.gallery, like a picture dictionary for interfaces.

The full prompt library comes with our Basics of Software for Vibe Coding course on LittleParrot.app. First challenge free.
...
.
.
#vibecoding #buildwithai #womenwhobuild #uidesign #shebuilds #womenintech #techforwomen #learnwithai #appbuilding #digitalskills #codingforbeginners
