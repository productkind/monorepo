...
# Post 1: The credit-drain comic (Dalmie's story)

**Pillar:** the messy middle, told as a story. **Research trace:** credits are the No. 1 blocker in our own feedback and on r/lovable; comics frame the learner's pain, not the tool; reuses made assets (the course's four comic panels), per the reuse-first Instagram rule.
...
**Carousel, 5 slides, 1080 x 1080 (square, to match the panel art).** Slides 1 to 4 are the existing comic panels from `little-parrot/content/images/comics/vibe-coding-github-00/` (panel-00 to panel-03), exported as PNG. Slide 5 is a simple brand-colour text card.

| Slide | Visual | Text on slide |
| --- | --- | --- |
| 1 | panel-00: Dalmie at her laptop, credit counter ticking down | (in panel) "A few more fixes for my Book Club Organiser app... and there go my credits again." |
...
**Alt text (for the post):** A four-panel comic. Dalmie the dalmatian watches her Lovable credits drain on small fixes, wonders if there's a free way, and Little Parrot suggests setting up a workspace on her own computer. Dalmie is excited to start. A final card announces the course.
...
Our new course shows you how, step by step:

🛠️ set up a builder's workspace (VS Code, GitHub, all free) 💻 run your app on your own computer and change copy and icons yourself 🤖 hand the bigger jobs to GitHub Copilot's free tier, and review its work
