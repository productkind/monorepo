...
Eight outcome-led videos for the Building Apps with AI waitlist campaign. Each
script is designed for roughly 45 seconds of narration and follows the same
shape as the technical Product Manager validation videos: a recognisable
situation, its consequence, the capability the learner is missing, the
learning-path response, a concrete outcome, the waitlist call to action and a
question that invites comments.

- **Brand:** Little Parrot
- **Audience:** Women who have already built a working app with AI and want to
  prepare it for customers, payments and ongoing changes
- **Channels:** LinkedIn, TikTok, Instagram Reels and YouTube Shorts
- **Destination:** `https://littleparrot.app/guides/building-apps-with-ai`
- **Format:** Narration with burned-in subtitles and changing screen recordings
- **Timing:** Approximately 45 seconds at 2.95 spoken words per second
...
and working practices described on the waitlist page. They do not promise that
every app will become secure, compliant, profitable or ready for unrestricted
use.
