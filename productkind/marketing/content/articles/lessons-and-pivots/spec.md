...
**Story arc:** the honest tiny number I opened with (slide 1), that I wrote
about it anyway (2), what didn't work (3), the turn: each flop was telling
me something (4), the two lessons the flops gave me (5 to 6), the pivot they
pointed to (7), the invitation (8). Follows the narrative of Kinga's own
LinkedIn post about the article. A fellow-learner retrospective, never from
above; the throughline is the honest telling, not an added moral.

## Format

**Carousel, 8 slides, 1080 x 1350 (4:5 portrait).** Editorial, personal
productkind style: warm palette, generous whitespace, Kim mascot on the
cover and CTA. A big-number treatment for the Instagram stats, a black
statement card for the two hard-won lessons, a warm gradient for the pivot.

**Export note:** the same 1080 x 1350 export works on all three channels.
TikTok photo mode pads the sides; keep all text inside the central safe area.
...
comics that took hours and never found new people, and the lessons each flop
gave, that Instagram carousels don't reach non-followers, and to know who
you're building for before a conference, leading to a pivot towards helping
women who can't code yet build their own products.
...
*(House style keeps hashtags to Instagram; if you want discovery tags on TikTok, reuse two or three from the Instagram set, e.g. #buildinpublic #vibecoding #womenintech.)*
