...
# Where my Substack subscribers actually came from

**Angle:** I believed the received wisdom that switching on paid subscriptions makes the Substack algorithm promote your articles. When I looked at the data, 44% of this year's new subscribers came from LittleParrot.app, via a subscribe box I added the same day. A reminder to question assumptions and validate hypotheses with data.
...
But I also wanted to reach more people. So I gave in.

Over the next months, new subscribers started to trickle in, even though I wasn't publishing new articles. I was like, 'wow, I should have switched this on sooner.'
