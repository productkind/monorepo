...
courses). None of it repeats the slide copy word for word.

---

## Instagram (carousel PNGs, Collab post with Kinga's personal account)
...
So we make Little Parrot: short, hands-on, science-based courses that teach women to make software, tools and systems with AI, ten minutes at a time, whether or not you think of yourself as technical. They're built on what we know from our own work, and beginner questions are welcome in them.

Swipe to meet us properly: luxury fashion, a move abroad, a developer bootcamp, ten years in tech, and the free course 663 people registered for this March.
...
**Alt text:** A ten-slide photo carousel introducing the two people behind productkind. Slide one, a portrait of Kinga and Tamas at a conference, says Little Parrot teaches women to make software, tools and systems with AI without a technical background. The next slides tell Kinga's story: starting her career in luxury fashion, moving countries and joining a tech company, over ten years in tech through a developer bootcamp to Lead Product Manager, leaving her full-time product role to do work with a more positive impact, trying coaching and consulting, then building Little Parrot and seeing the bigger opportunity of closing the gender gap in AI adoption. Tamas joins as technical partner and educator, 663 people register for the free International Women's Day course, and the first strangers pay for subscriptions from South Korea, England, the US and Australia. The last slide, a laptop in Finland, invites the reader to try building their own idea.

**Founder comments** (post within the first hour):

- **Kinga:** Slide 4 took me the longest to write. "I left my full-time product role" reads tidy now, at the time I had no plan past wanting to help women, and there was a long stretch of coaching, consulting and experiments before Little Parrot existed. Anyone else in that in-between bit right now?
...
## TikTok (carousel PNGs, photo mode)

**Title:** Only about 1 in 5 people building with AI are women 🦜

**Caption:**

We're Kinga and Tamas, a two-person company, and closing that gap is the only thing we work on. We make short, hands-on courses that teach women to build their idea with AI, ten minutes at a time, without a technical background. Swipe through to meet us. Follow to see what we're building, what's working and what flops.
...
## LinkedIn (productkind page, PDF document post)

**Caption:**

Only about one in five people building with AI are women. Closing that gap is why productkind exists, and it's the only thing the two of us work on.

AI app builders changed who can make software. You describe what you want in ordinary words and get a working app back, without writing the code yourself. So far, most of the people using them come from the same backgrounds as the people who were already building software.
...
So we make Little Parrot: short, hands-on, science-based courses that teach women to make software, tools and systems with AI, ten minutes at a time. Kinga spent over ten years in tech, did a developer bootcamp and worked as a Lead Product Manager before leaving her full-time role to build this. Tamas is the technical partner and educator. The courses come from our own work, they're written for someone who has an idea and no technical background, and beginner questions are welcome.
...
- **Kinga:** The photos cover about ten years: luxury fashion, then tech, then the workshops we ran last year at NDC Copenhagen and Wey Wey Web in Málaga, and the Productized talk in Lisbon. The jump between slide 4 and slide 6, leaving my product role and starting Little Parrot, took far longer than the carousel makes it look. If you're somewhere in that middle bit, weighing up leaving a role you're good at, I'm happy to talk about how it actually went.
- **Tamas:** In our workshops, the surprise is always what happens after the AI app builder hands back something that doesn't work. Reading what came back, describing the problem precisely enough to get it fixed, and knowing when to start the prompt again is most of what we teach. Getting a first version out of the AI app builder is the quick bit, the rest is the job.
...
- Two details left out because they aren't in any source we hold: how long the
  coaching and consulting stretch actually lasted, and whether the luxury
  fashion job was in Singapore. Add them back if they're right.
- One note on the carousel itself: slide 10's "get from 'Could I build this?'
  to opening your laptop" is the "from X to Y" transformation phrasing we
  avoid. Something like "Maybe you have an idea too. We'd like to help you open
  your laptop and try it" says the same thing without it.
