...
| The payoff (32-44s) | "I'm not starting from scratch every time. That's maybe fifteen minutes back on every task, which adds up fast when there's two of you doing everything." | — |
| The takeaway (44-55s) | "If you use AI for the same task more than a couple of times a week, write your instructions down once and keep them where the tool can read them. In most tools that's a custom instruction or a project file." | — |
| CTA | "Follow for more small ways to get AI doing the boring parts." | littleparrot.app |

**Screen recording needed:** the real instructions file (blur anything private).
