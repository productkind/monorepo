...
> Authenticity is a filter to apply, not a style to adopt.
...
## 2. Use the specific, not the general
...
## 3. Write ugly first drafts

Write the post you'd send to a trusted colleague — then lightly edit for **clarity**, not polish.

Many people edit out the most interesting parts in pursuit of a clean, professional tone. Your rough first instinct, before you've sanitised it, is often where the authentic voice lives.

---

## 4. Let your opinions be uncomfortable

Posts that push back against conventional wisdom or express a minority view get disproportionate engagement.

If you feel completely comfortable with a post before hitting publish, you may have smoothed it into blandness. Authentic posts often make the writer slightly nervous to share.
...
## 7. Write posts only you could write

Use your specific context, perspective, and combination of experiences. Posts that could have been written by anyone in your field are easily ignored. Posts that could only have been written by you are the ones that build a real audience.
