# Little Parrot Niche Research

This folder contains the search-led niche research method and its Little Parrot implementation.

## Files

- [`niche-research-method.md`](niche-research-method.md): reusable method for finding a search niche that can support a self-serve digital product.
- [`little-parrot-niche-research.md`](little-parrot-niche-research.md): Little Parrot-specific research workbook, five candidate markets, product hypotheses, research sequence, scorecards and decision record.
...
The scores remain provisional until the Keyword Planner volume gate and price-qualified content test have been completed. Do not turn the recommended first test into a final niche decision before those results exist.
