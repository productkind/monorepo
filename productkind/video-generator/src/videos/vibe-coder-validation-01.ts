...
/**
 * Video 1 of the vibe coder campaign, "You asked for one button".
  ...
  sections: [
    {
      ...
      visual: gif({ src: 'section-00-chat-request.gif', place: 'above-captions' }),
    },
    {
      // giphy "papers flying out of laptop": https://giphy.com/gifs/XbBJTYS9hDeUFpTxwU
      text: 'The AI changed fourteen files.',
      visual: gif({ src: 'section-01-files-flying.gif', place: 'above-captions' }),
      endsParagraph: true,
    },
    {
    ...
    },
    {
      ...
      visual: gif({ src: 'section-09-chick-writing-notes.gif', place: 'above-captions' }),
    },
    {
    ...
    },
    {
      ...
      visual: gif({ src: 'section-11-rocket-launch-ready.gif', place: 'above-captions' }),
      endsParagraph: true,
    },
    {
      // giphy "confident woman smiling laptop": https://giphy.com/gifs/fuHp2yhQ91ceA
      text: 'If you want that control over your own app,',
      visual: gif({ src: 'section-12-woman-confident-smile.gif', place: 'above-captions' }),
    },
    {
    ...
    },
    {
      ...
      visual: gif({ src: 'section-14-cat-reviews-laptop.gif', place: 'above-captions' }),
    },
    {
    ...
    {
      // giphy "woman curious thinking question": https://giphy.com/gifs/bMT1T4T5efd42XoM00
      text: '[pause][curious] What’s the biggest change you’ve approved without understanding it?',
      visual: gif({
        src: 'section-20-cartoon-girl-curious.gif',
        color: '#000000',
        place: 'above-captions',
      }),
    },
