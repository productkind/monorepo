...
/**
 * Video 6 of the vibe coder campaign, "Could one customer increase your bill?".
  ...
  sections: [
    {
      ...
      visual: gif({
        src: 'section-00-worried-phone-call.gif',
        source: { provider: 'klipy', search: 'woman worried phone bill' },
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: { provider: 'klipy', search: 'app development tools flat icon' },
        color: '#fcfefc',
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'dvViwfnYOy76fnrMqm',
          search: 'paper airplane sending message animation',
        },
        color: '#ee9ce1',
        playbackRate: 0.83,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-03-shape-morph-different.gif',
        source: {
          provider: 'giphy',
          id: 'kKJOl2NsnibMMNjUkH',
          search: 'assorted shapes flat lay variety',
        },
        place: 'above-captions',
      }),
    },
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'MTsnRpROcrxWS6wwta',
          search: 'stack growing taller blocks',
        },
        color: '#f2f2f2',
        place: 'above-captions',
      }),
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'GAmXgbPLJAjQOsyw8u',
          search: 'quick doodle sketch hand drawing simple',
        },
        color: '#ffe7cd',
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'ojiP8Hymf5Vkcdw1A9',
          search: 'confused math calculation cute character',
        },
        color: '#000000',
        playbackRate: 0.91,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'QytRJAvwnaU7rvvjxC',
          search: 'calculator screen number result animation',
        },
        playbackRate: 0.95,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        src: 'section-09-hexagons-multiplying.gif',
        source: { provider: 'klipy', search: 'dots forming crowd grid animation' },
        place: 'above-captions',
      }),
    },
    {
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'n204doxIAfJWbgCFkv',
          search: 'woman working laptop cafe focused',
        },
        playbackRate: 0.78,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        src: 'section-12-caterpillar-becomes-butterfly.gif',
        source: {
          provider: 'giphy',
          id: 'fDC4ZpkHggPyji32m8',
          search: 'caterpillar butterfly transformation',
        },
        place: 'above-captions',
      }),
      endsParagraph: true,
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'f7kDY17LNy7NokAjy0',
          search: 'tally marks counting paper animation',
        },
        playbackRate: 1.32,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'fng8OzU2DvO2NCGeLY',
          search: 'pie chart filling animation flat',
        },
        color: '#ffffff',
        playbackRate: 0.78,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'P54O7IqCTQuTABVUcC',
          search: 'warning alert triangle icon flat animation',
        },
        color: '#000000',
        playbackRate: 0.73,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'c6YbhJZ9PZ54dbjR1C',
          search: 'woman celebrating success laptop confident',
        },
        playbackRate: 0.83,
        place: 'above-captions',
      }),
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-17-woman-points-down.gif',
        source: {
          provider: 'giphy',
          id: 'ZQpFjNPJ3cEitXpphT',
          search: 'hand pointing downwards illustration',
        },
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'l0IyhFAkW40x1Abx6',
          search: 'sunrise time lapse horizon',
        },
        playbackRate: 0.84,
        place: 'above-captions',
      }),
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: { provider: 'klipy', search: 'curious cute character tilting head animation' },
        color: '#fcfefc',
        playbackRate: 0.9,
        place: 'above-captions',
      }),
