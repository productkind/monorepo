  ...
  sections: [
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: '0IAPszdB8MMjPxNhFL',
          search: 'sticky notes brainstorm cartoon',
        },
        color: '#fdfdfd',
        playbackRate: 0.91,
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-01-zip-lips.gif',
        source: { provider: 'giphy', id: 'q0wz0pS8S8J4x3ztcZ', search: 'silence emoji sticker' },
        place: 'above-captions',
      }),
      endsParagraph: true,
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'hVJZt4rY9TR5rmmqfc',
          search: 'cute animal builder construction cartoon',
        },
        playbackRate: 0.85,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        src: 'section-03-question-marks-flood.gif',
        source: {
          provider: 'giphy',
          id: 'szmc6VgQeft0A',
          search: 'puzzled character thinking question mark cartoon',
        },
        place: 'above-captions',
      }),
      endsParagraph: true,
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'mCnNJF00DZbXlEy1TH',
          search: 'candle burning down melting animation',
        },
        color: '#faffe9',
        playbackRate: 0.99,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-05-shocked-eyes.gif',
        source: {
          provider: 'giphy',
          id: 'YMMFYhYmQqldjK1DiX',
          search: 'surprised gasp cute animal cartoon',
        },
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'Uimc9luSqGu4FcchR4',
          search: 'gps rerouting arrow cartoon',
        },
        color: '#000000',
        playbackRate: 0.81,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'giphy',
          id: 'PUITId5Avf9fLPpD3S',
          search: 'superhero cape cartoon character responsibility',
        },
        playbackRate: 0.84,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'klipy',
          id: '8174098648891218',
          search: 'flying blind no guide cartoon character',
        },
        color: '#fcfefc',
        playbackRate: 0.9,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-09-woman-speaking-studio.gif',
        source: {
          provider: 'klipy',
          id: '5154629516360151',
          search: 'girl boss speaking confidently flat illustration',
        },
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'klipy',
          id: '1455085414786298',
          search: 'building blocks stacking cartoon construction',
        },
        color: '#fcfcfc',
        playbackRate: 0.9,
        place: 'above-captions',
    ...
    },
    {
      ...
      visual: gif({
        src: 'section-11-two-talking.gif',
        source: {
          provider: 'giphy',
          id: 'g0jlZ04SeV4AM1lvFw',
          search: 'two cute animals talking conversation cartoon',
        },
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'klipy',
          id: '1619033811077124',
          search: 'confused yellow cat sticker',
        },
        color: '#fcfefc',
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: { provider: 'klipy', id: '7280182075842537', search: 'yellow cat line sticker' },
        color: '#040204',
        playbackRate: 0.83,
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: { provider: 'klipy', id: '3179749758484000', search: 'yellow cat line sticker' },
        color: '#040204',
        playbackRate: 0.59,
        place: 'above-captions',
      }),
    ...
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'klipy',
          id: '7547006698239934',
          search: 'arrow pointing downward simple animation',
        },
        color: '#fcfefc',
        place: 'above-captions',
      }),
    },
    {
      ...
      visual: gif({
        ...
        source: {
          provider: 'klipy',
          id: '5849066022004513',
          search: 'cute character ringing bell sticker',
        },
        playbackRate: 0.76,
        place: 'above-captions',
      }),
