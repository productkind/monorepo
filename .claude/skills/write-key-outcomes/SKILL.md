...
| Discover | Elaborate | Experiment | Connect | Critique | Construct |
| Examine | Estimate | Graph | Contrast | Decide | Create |
| Explain what | Explain why | Imagine | Deconstruct | Defend | Demo |
| Identify | Give examples | Implement | Dissect | Judge | Design |
| Illustrate | Infer | Manipulate | Distill | Justify | Develop |
| List | Interpret | Model | Distinguish | Prioritise | Invent |
| Listen | Paraphrase | Practice | Examine | Propose | Produce |
| Match | Predict | Sketch | Simplify | Recommend | Present |
